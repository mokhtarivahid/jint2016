...
robot_activity_experience(
	...
	[
		serve_coffee_to_guest(mug1,guest1,table1),	%% Task
		[						%% KeyProps
		...
		[	%% actions
			...
			pick_up_object(mug1, rightarm1, on4, robotat7, manipulationareaeastcounter1, placingareaeastrightcounter1, rightgripper1, holding_0x0, torsoupposture2, armtosideposture23, armtosideposture33),
			move_base_blind_to_pma(robotat7, manipulationareaeastcounter1, robotat9, premanipulationareaeastcounter1),
			move_arms_to_carryposture(leftarm1, rightarm1, armtosideposture, armtosideposture, armtosideposture21, armtosideposture33, armcarryposture37, armcarryposture39),
			...
			place_object(mug1, rightarm1, robotat15, manipulationareasouthtable1, on_0x0, placingareawestrighttable1, rightgripper1, holding_0x0, torsoupposture6, armtosideposture53, armtosideposture1011),
...
robot_activity_experience(
	...
	[
		...
		[	%% actions
			...
			move_base(robotat0, floorareatamsrestaurant1, robotat5, premanipulationareasouthtable1),
			move_torso(torso1, torsodownposture, torsodownposture0, torsoupposture, torsoupposture2),
			...
			move_base_blind_to_ma(robotat5, premanipulationareasouthtable1, robotat8, manipulationareasouthtable1),
			pick_up_object(mug1, leftarm1, on5, robotat8, manipulationareasouthtable1, placingareawestrighttable1, leftgripper1, holding_0x1, torsoupposture2, armtosideposture23, armtosideposture33),
			move_base_blind_to_pma(robotat8, manipulationareasouthtable1, robotat23, premanipulationareasouthtable1),
			...
			move_base(robotat23, premanipulationareasouthtable1, robotat28, premanipulationareaeastcounter1),
			...
			move_base_blind_to_ma(robotat28, premanipulationareaeastcounter1, robotat31, manipulationareaeastcounter1),
			place_object(mug1, leftarm1, robotat31, manipulationareaeastcounter1, on_0x5, placingareaeastrightcounter1, leftgripper1, holding_0x1, torsoupposture10, armtosideposture101, armtosideposture108),
			move_base_blind_to_pma(robotat31, manipulationareaeastcounter1, robotat33, premanipulationareaeastcounter1)
		]
	]
)).
...
robot_activity_experience(
        ...
        put_object,                             %% problem
        [
                put_object(mug1,placingareawestrighttable1),    %% Task
                [                                               %% KeyProps
                        at_start(instance(torsomiddleposture, torsomiddleposture13)),
                        at_start(haspassiveobject(holding_0x1, mug1)),
                        at_start(instance(armcarryposture, armcarryposture17)),
                        at_start(hasarmposture(rightarm1, armcarryposture17)),
                        at_start(instance(armcarryposture, armcarryposture21)),
                        at_start(hasarmposture(leftarm1, armcarryposture21)),
                        at_start(hasgripperposture(rightgripper1, gripperholdingposture6)),
                        at_start(hasgripperposture(leftgripper1, gripperclosedposture1)),
                        at_start(hasgripper(holding_0x1, rightgripper1)),
                        at_start(hasarea(robotat9, premanipulationareasouthtable1)),
                        at_start(hasrobot(robotat9, trixi1)),
                        at_start(hastorsoposture(torso1, torsomiddleposture13)),
                        at_start(instance(gripperholdingposture, gripperholdingposture6)),
                        at_start(instance(robotat, robotat9)),
                        at_start(instance(holding, holding_0x1)),
                        throughout(haspremanipulationarea(table1, premanipulationareasouthtable1)),
                        throughout(instance(table, table1)),
                        throughout(instance(arm, leftarm1)),
                        throughout(hasplacingarearight(sittingareawesttable1, placingareawestrighttable1)),
                        ...
                        throughout(hasmanipulationarea(table1, manipulationareanorthtable1)),
                        throughout(instance(on, on1)),
                        at_end(instance(torsoupposture, torsoupposture15)),
                        at_end(hasgripperposture(rightgripper1, gripperopeningposture11)),
                        at_end(hasgripperposture(leftgripper1, gripperclosedposture1)),
                        at_end(hasarmposture(rightarm1, armtosideposture33)),
                        at_end(hasarea(on_0x0, placingareawestrighttable1)),
                        at_end(on(mug1, placingareawestrighttable1)),
                        at_end(instance(gripperopeningposture, gripperopeningposture11)),
                        at_end(instance(robotat, robotat15)),
                        at_end(instance(on, on_0x0)),
                        at_end(hasphysicalentity(on_0x0, mug1)),
                        at_end(instance(armtosideposture, armtosideposture33)),
                        at_end(instance(armtosideposture, armtosideposture1011)),
                        at_end(hasarea(robotat15, manipulationareasouthtable1)),
                        at_end(robotat(trixi1, manipulationareasouthtable1)),
                        at_end(hastorsoposture(torso1, torsoupposture15)),
                        at_end(hasarmposture(leftarm1, armtosideposture1011))
                        at_end(hasrobot(robotat15, trixi1))
                ],
                [       %% actions
                        move_torso(torso1, torsomiddleposture, torsomiddleposture13, torsoupposture, torsoupposture15),
                        move_arm_to_side(leftarm1, armcarryposture, armcarryposture21, armtosideposture1011),
                        move_arm_to_side(rightarm1, armcarryposture, armcarryposture17, armtosideposture33),
                        move_base_blind_to_ma(robotat9, premanipulationareasouthtable1, robotat15, manipulationareasouthtable1),
                        place_object(mug1, rightarm1, robotat15, manipulationareasouthtable1, on_0x0, placingareawestrighttable1, rightgripper1, holding_0x1, torsoupposture15, armtosideposture33, armtosideposture1011)
                ]
        ]
)).
