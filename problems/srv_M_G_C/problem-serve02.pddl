...
(define (problem serve_coffee_to_guest5 mug1 guest1 counter1)

(:domain race)

(:objects   armtuckedposture0 armtuckedposture1 - armtuckedposture
            torsodownposture0 - torsodownposture
...
(:INIT
            ...
            (instance armtuckedposture armtuckedposture0)
            (instance armtuckedposture armtuckedposture1)
            (hasarmposture leftarm1 armtuckedposture0)
            (hasarmposture rightarm1 armtuckedposture1)
            ...
            (instance torsodownposture torsodownposture0)
            (hastorsoposture torso1 torsodownposture0)
)
