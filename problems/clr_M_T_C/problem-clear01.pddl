...
(define (problem clear_table6 mug1 table1 counter1)
...
(:INIT
            ...
            (on mug1 placingareaeastrighttable1)
            ;(on mug2 placingareanorthrighttable2)
            ;(on mug3 placingareasouthrighttable2)
